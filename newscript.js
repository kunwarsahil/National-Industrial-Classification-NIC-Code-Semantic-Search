const nicData = {
    ...
    4777: "Retail sale of watches and jewelry",
    6202: "Computer consultancy and computer facilities management",
    9001: "Performing arts activities",
...
function searchNIC() {
    ...
    if (input && nicData[input]) {
        resultContainer.innerHTML = `<div class="nic-item"><strong>${input}</strong> - ${nicData[input]}</div>`;
    } else {
        resultContainer.innerHTML = "<div class='nic-item'>No results found</div>";
    }
}
